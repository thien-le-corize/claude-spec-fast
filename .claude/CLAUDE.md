...
**ALWAYS respond in the user's language.** If the user writes in Vietnamese, respond in Vietnamese. If English, respond in English. Match the user's language automatically.

Default language setting: See `settings.json` → `"language"` field.
